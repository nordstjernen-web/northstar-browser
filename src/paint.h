...
guint64 ns_paint_font_generation(void);
...
double ns_paint_text_spacing_px(const ns_css_value *v);
void ns_paint_apply_text_spacing(NsPangoAttrList *attrs, const ns_style *style);
